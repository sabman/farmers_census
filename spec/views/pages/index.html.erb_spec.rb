...
describe "/pages/index.html.erb" do
  ...
  before(:each) do
    ...
    page_98.should_receive(:name).and_return("MyString")
    page_98.should_receive(:permalink).and_return("MyString")
    page_98.should_receive(:content).and_return("MyText")
    page_99 = mock_model(Page)
    page_99.should_receive(:name).and_return("MyString")
    page_99.should_receive(:permalink).and_return("MyString")
    page_99.should_receive(:content).and_return("MyText")
